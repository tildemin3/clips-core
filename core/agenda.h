 ...
 * @brief Enumeration for salience evaluation types.
 */
typedef enum
  {
   WHEN_DEFINED,
...
/**
 * @struct activation
 * @brief Structure representing an activation in the agenda.
 */
struct activation
  {
   Defrule *theRule;
 ...
 * @brief Structure representing a salience group in the agenda.
 */
struct salienceGroup
  {
   int salience;
...
/**
 * @struct agendaData
 * @brief Structure containing agenda-related data.
 */
struct agendaData
  {
